...
export default function Login() {
  ...
  const loginMutation = useLogin({
    onSuccess: (data) => {
      // Tokens are now stored automatically by apiClient.login()
  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      // and stored in loginMutation.error
    }
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        {/* <Card className="bg-blue-50 border-blue-200">
          <CardContent className="pt-6">
            <h3 className="text-sm font-medium text-blue-900 mb-2">Integration Notes:</h3>
            <ul className="text-xs text-blue-800 space-y-1">
              <li>• Uses your custom useLogin hook with React Query</li>
              <li>• Automatically handles loading states and errors</li>
              <li>• Stores auth token in localStorage on success</li>
